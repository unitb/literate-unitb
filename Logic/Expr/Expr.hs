...
type Expr = AbsExpr GenericType Quantifier
...
type UntypedExpr = GenExpr () GenericType Quantifier
...
instance IsQuantifier Quantifier where
...
type Context = AbsContext GenericType Quantifier
...
type FODef = AbsDef FOType Quantifier

type Def = AbsDef GenericType Quantifier
