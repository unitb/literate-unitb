...
\begin{align*}
&	\progress{prog5}{\true}{ n = k+2 }
\refine{prog5}{transitivity}{prog6,prog7}{    }
&	\progress{prog6}{ n = k }{ n = k+1  }
\\ &	\progress{prog7}{ n = k+1 }{ n = k+2  }
\end{align*}

\begin{align*}
&	\progress{prog8}{n = k}{ n = k+2 }
\refine{prog8}{transitivity}{prog9,prog10}{    }
&	\progress{prog9}{ \true }{ n = k+1  }
\\ &	\progress{prog10}{ n \le k+1 }{ n = k+2  }
\end{align*}
