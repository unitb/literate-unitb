...
\begin{indices}{m0:leave}
	t : \Train
\end{indices}
\begin{indices}{m0:enter}
	t : \Train
\end{indices}
...
&\progress{prog0}
	{	t \in in }{ \neg t \in in }
\refine{prog0}{discharge}{tr0}{}
&\transient{m0:leave}{0}{tr0}
	{	t \in in }
\end{align*}
...
\replace{m0:leave}{1}{c0}{c0,c1}{}{prog0}{saf3}
...
%\end{align*}
\hide{
	\refine{prog3}{discharge}{tr0,saf2}{}
	\refine{prog4}{discharge}{tr1,saf1}{}
}
\begin{align*}
%\\ & \safety{saf5}
%	{ t \in in \land loc.t \in plf }{ t \in in \land loc.t = ext }
