...
\replace{m0:leave}{1}{lv:c0}{lv:c0,lv:c1}{}{m1:prog0}{saf3}
...
%
\eqref{m1:prog2} is true by implication. This leaves us \eqref{m1:prog1} and \eqref{m1:prog3}. \eqref{m1:prog1} says that a train at the entrance reaches the exit. However, \eqref{saf1} says that a train can only leave the entrance through a platform:
...
\hide{
	\refine{m1:prog3}{discharge}{m1:tr0,saf2}{}
	\refine{m1:prog4}{discharge}{m1:tr1,saf1}{}
}
\begin{align*}
...
\weakento{m1:movein}{0}{default}{mi:c1,mi:c2}{}
...
\subsection{Design}
%
\replace{m1:movein}{1}{}{mi:c0}{}{m2:prog0}{m2:saf0}
\begin{align*}
...
\replacefine{m1:moveout}{1}{}{}{mo:f0}{m2:prog1} 
