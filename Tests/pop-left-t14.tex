...
\begin{align*}
  ...
  \initialization{m0:init6}
    { \qexists{x}{}{\trash = dummy \fun [ 'item := x, 'left := dummy, 'right := dummy ] } } \\
  \initialization{m0:init7}{ popL = \false } \\
  \initialization{m0:init8}{ remL = \false } \\
  \initialization{m0:init9}{ resL = \bot } \\
  \definition{\shared}{ \trash \1| \link }
\end{align*}
...
\removecoarse{hdl:popL:more}{m0:sch1}
\removecoarse{hdl:popL:more}{m0:sch2}
...
\begin{align*}
  \refine{m2:prog0}{ensure}{read:RH}{}
\end{align*}
\begin{align*}
...
\end{align*}
    ...
    % \removecoarse{hdl:popL:one}{m0:sch0} 
  % \mergeevents{foo}{bar}
\subsection{ popL more }

\removecoarse{hdl:popL:more}{m0:sch3}
\replace{hdl:popL:more}{m2:sch0}{m2:prog0}
\begin{align*}  
  &\cschedule{hdl:popL:more}{m2:sch0}
    { rh = RH } \\
  &\cschedule{hdl:popL:more}{m2:sch1}
    { \neg lh = rh } \\
\end{align*}
...
\removeact{hdl:popL:more}{m0:act6}
\replace{hdl:popL:more}{m2:sch2}{m2:prog1}
\begin{align*}
  \cschedule{hdl:popL:more}{m2:sch2}
    { lhR = \link.lh.'right } \\
  \evbcmeq{hdl:popL:more}{m2:act0}{LH}{ lhR }
\end{align*}

\begin{align*}
  % \invariant{m2:inv0}{ lh \in \dom.\link \bunion \{dummy\}}
  \progress{m2:prog1}
    {state = \cNonEmpty}
    {lhR = \link.lh.'right 
      \lor \neg lh = LH
      \lor lh = dummy }
\refine{m2:prog1}{ensure}{read:lh:R}{}
\end{align*}

\newevent{read:lh:R}{read\_lh\_R}

\begin{align*}
  \cschedule{read:lh:R}{m2:sch0}
    { state = \cNonEmpty } \\
  \evbcmeq{read:lh:R}{m2:act0}
    {lhR}{ \shared.lh.'right }
\end{align*}
