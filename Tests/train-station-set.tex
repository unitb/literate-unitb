...
\replace{m1:moveout}{}{m3:mo:sch0}{c1}{m3:prog0}{m3:saf0}
	% it works because the PO is trivial p |-> true
\replacefine{m1:moveout}{}{mo:f0}{}{m3:prog0}
...
\begin{align*} 
	\invariant{m3:inv2}{ \qforall{t}{}{t \in in \land loc.t \in osgn \1\implies \neg \, ext \in \ran.loc } }
\\	\invariant{m3:inv3}{ \qforall{p}{}{ p \in osgn \1\implies p \in \ran.loc } }
\end{align*}
