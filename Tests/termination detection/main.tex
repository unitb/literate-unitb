...
\end{align}
	\replace{detect}{m1:sch0}{m2:sch0}{}{m2:prog0}{m2:saf0}
\begin{align}
...
\begin{calculation}
	d' \setminus \qset{p,q}{ q \in delta'.p }{q}
\hint{=}{ \eqref{m3:act1} }
	d' \setminus \qset{p_0,q}{ q \in (delta \1| p \fun \emptyset).p_0 }{q}
\hint{=}{ function overriding }
	d' \setminus (\qset{p_0,q}{ q \in delta.p_0 \land \neg p_0 = p }{q} \bunion \qset{p_0,q}{ \oftype{q}{Pcs} \in \emptyset \land p_0 = p }{q})
\hint{=}{ empty range }
	d' \setminus \qset{p_0,q}{ q \in delta.p_0 \land \neg p_0 = p }{q}
\hint{=}{ set theory }
	% need quantified union
	d' \setminus \qset{q}{ \qexists{p_0}{}{ q \in delta.p_0 \land \neg p_0 = p } }{q}
\hint{=}{ \eqref{m2:act0} }
	(d \bunion \{p\}) \setminus \qset{p_0,q}{ q \in delta.p_0 \land \neg p_0 = p }{q}
\hint{\supseteq}{}
	b'
\end{calculation}
\end{proof}
