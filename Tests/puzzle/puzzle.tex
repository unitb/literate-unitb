...
\comment{flick}{stuff}
	...
	\begin{itemize}
		\item \removevar{cs}
		\item \removevar{ts}
		\item \removeact{count}{act0,act1}
		\item $\witness{count}{cs}{cs' = \emptyset}$
		\item \removeact{flick}{act0}
		\item \removeinit{in2} \removeinit{in1}
		\item $\initwitness{cs}{cs = \emptyset} $
		\item $\initwitness{ts}{ts = \emptyset}$
	\end{itemize}
	\begin{align} 
