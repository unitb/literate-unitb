...
\newevent{m0:pop:right:empty}{pop\_right}
...
\newevent{m0:pop:right:non:empty}{pop\_right}
...
\comment{$emp$}{this encodes whether the last call to pop found the queue empty
; more text, more text, still more text, and here's more text}
