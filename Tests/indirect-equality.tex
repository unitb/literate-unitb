...
\begin{proof}{THM/\ref{thm0}}
	\begin{free:var}{x}{y_0}
	\begin{free:var}{y}{y_1}
	\begin{by:parts} \\
		\begin{part:a}{y_0 = y_1 \2\implies \qforall{z}{}{ y_0 \le z \1\equiv y_1 \le z }}
		\easy 
%		It's easy: check this out
%		banana
		\end{part:a}

		\begin{part:a}{ \qforall{z}{}{ y_0 \le z \1\equiv y_1 \le z } \2\implies y_0 = y_1 }
		\begin{align}
		\assume{hyp0}{\qforall{z}{}{ y_0 \le z \1\equiv y_1 \le z }} \\
		\goal{ y_0 = y_1 }
		\end{align}
		\begin{calculation}
			y_0 = y_1
		\hint{=}{ antisymmetry of $\le$ }
			y_0 \le y_1 \1\land y_1 \le y_0
		\hint{=}{ \eqref{hyp0} }
%		\hint{=}{  }
			y_1 \le y_1 \1\land y_0 \le y_0
		\hint{=}{ reflexivity of $\le$ }
			\true
		\end{calculation}
		\end{part:a}
	\end{by:parts}
