...
test :: IO Bool
test = test_cases [
        (Case "small machine, test 0" case0 $ Right $ [m0_machine]),
        (Case "small machine, test 1 (separate machine blocks)" case1 $ Right $ [m1_machine]),
        (StringCase "small machine, test 2 (verification, one failure)" case2 result2),
        (StringCase "small machine, test 3 (verification)" case3 result3),
        (StringCase "small machine, test 4 (proof obligation, invariance)" case4 result4),
        (StringCase "small machine, test 5 (co, 'skip' proof obligation)" case5 result5) ]
