...
result5 = unlines 
    ...
    , "(declare-fun set@@Int@@sl@G ( (pfun Int sl@G) ) (set sl@G))"
    , "(declare-fun set@@sl@REQ@@sl@G ( (pfun sl@REQ sl@G) ) (set sl@G))"
    ...
    , "                   :pattern"
    , "                   ( (select (dom@@sl@REQ@@sl@G f1) x) ))))"
    , "(assert (forall ( (y sl@G)"
    , "                  (f1 (pfun Int sl@G)) )"
    , "                (! (= (elem@@sl@G y (set@@Int@@sl@G f1))"
    , "                      (exists ( (x Int) )"
    , "                              (and (elem@@Int x (dom@@Int@@sl@G f1))"
    ...
    , "(assert (forall ( (y sl@G)"
    , "                  (f1 (pfun sl@REQ sl@G)) )"
    , "                (! (= (elem@@sl@G y (set@@sl@REQ@@sl@G f1))"
    , "                      (exists ( (x sl@REQ) )"
    , "                              (and (elem@@sl@REQ x (dom@@sl@REQ@@sl@G f1))"
    ...
    , "(assert (forall ( (f1 (pfun Int sl@G))"
    , "                  (y sl@G) )"
    , "                (! (= (= (set@@Int@@sl@G f1) (mk-set@@sl@G y))"
    , "                      (forall ( (x Int) )"
    , "                              (=> true"
    , "                                  (or (= (select f1 x) (Just y))"
    , "                                      (= (select f1 x) (as Nothing (Maybe sl@G)))))))"
    , "                   :pattern"
    , "                   ())))"
    , "(assert (forall ( (f1 (pfun sl@REQ sl@G))"
    , "                  (y sl@G) )"
    , "                (! (= (= (set@@sl@REQ@@sl@G f1) (mk-set@@sl@G y))"
    , "                      (forall ( (x sl@REQ) )"
    , "                              (=> true"
    , "                                  (or (= (select f1 x) (Just y))"
    , "                                      (= (select f1 x) (as Nothing (Maybe sl@G)))))))"
