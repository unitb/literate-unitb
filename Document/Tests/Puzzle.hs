...
result0 = unlines
    ...
    , "  o  m0/prog0/REF/ensure/SAF/WD/lhs"
    , "  o  m0/prog0/REF/ensure/SAF/WD/rhs"
    , "  o  m0/prog0/REF/ensure/TR/WD"
    , "  o  m0/prog0/REF/ensure/TR/term/EN"
    , "  o  m0/prog0/REF/ensure/TR/term/NEG"
    , "  o  m0/prog0/REF/ensure/term/SAF"
...
result1 = unlines
    ...
    , "  o  m1/prog3/REF/ensure/SAF/WD/lhs"
    , "  o  m1/prog3/REF/ensure/SAF/WD/rhs"
    , "  o  m1/prog3/REF/ensure/TR/WD"
    , "  o  m1/prog3/REF/ensure/TR/WD/witness/p"
    , "  o  m1/prog3/REF/ensure/TR/WFIS/p/p@prime"
    , "  o  m1/prog3/REF/ensure/TR/visit/EN"
    , "  o  m1/prog3/REF/ensure/TR/visit/NEG"
    , "  o  m1/prog3/REF/ensure/term/SAF"
    , "  o  m1/prog3/REF/ensure/visit/SAF"
...
case4 :: IO String
case4 = proof_obligation path0 "m1/prog3/REF/ensure/TR/visit/EN" 1

result4 :: String
result4 = unlines
    [ "; m1/prog3/REF/ensure/TR/visit/EN"
    , "(set-option :auto-config false)"
    , "(set-option :smt.timeout 3000)"
    , "(declare-datatypes (a) ( (Maybe (Just (fromJust a)) Nothing) ))"
    , "(declare-datatypes () ( (Null null) ))"
...
case5 :: IO String
case5 = proof_obligation path0 "m1/prog3/REF/ensure/TR/visit/NEG" 1

result5 :: String
result5 = unlines
    [ "; m1/prog3/REF/ensure/TR/visit/NEG"
    , "(set-option :auto-config false)"
    , "(set-option :smt.timeout 3000)"
    , "(declare-datatypes (a) ( (Maybe (Just (fromJust a)) Nothing) ))"
    , "(declare-datatypes () ( (Null null) ))"
...
result7 = unlines
    ...
    , "  o  m2/prog10/REF/ensure/SAF/WD/lhs"
    , "  o  m2/prog10/REF/ensure/SAF/WD/rhs"
    , "  o  m2/prog10/REF/ensure/TR/WD"
    , "  o  m2/prog10/REF/ensure/TR/count/EN"
    , "  o  m2/prog10/REF/ensure/TR/count/NEG"
    , "  o  m2/prog10/REF/ensure/count/SAF"
    , "  o  m2/prog10/REF/ensure/flick/SAF"
    , "  o  m2/prog10/REF/ensure/term/SAF"
    , "  o  m2/prog10/REF/ensure/visit/SAF"
    , "  o  m2/prog11/PROG/WD/lhs"
    , "  o  m2/prog11/PROG/WD/rhs"
    , "  o  m2/prog11/REF/ensure/SAF/WD/lhs"
    , "  o  m2/prog11/REF/ensure/SAF/WD/rhs"
    , "  o  m2/prog11/REF/ensure/TR/WD"
    , "  o  m2/prog11/REF/ensure/TR/WD/witness/p"
    , "  o  m2/prog11/REF/ensure/TR/WFIS/p/p@prime"
    , "  o  m2/prog11/REF/ensure/TR/visit/EN"
    , "  o  m2/prog11/REF/ensure/TR/visit/NEG"
    , "  o  m2/prog11/REF/ensure/count/SAF"
    , "  o  m2/prog11/REF/ensure/flick/SAF"
    , "  o  m2/prog11/REF/ensure/term/SAF"
    , "  o  m2/prog11/REF/ensure/visit/SAF"
    ...
    , "  o  m2/prog6/REF/ensure/SAF/WD/lhs"
    , "  o  m2/prog6/REF/ensure/SAF/WD/rhs"
    , "  o  m2/prog6/REF/ensure/TR/WD"
    , "  o  m2/prog6/REF/ensure/TR/WD/witness/p"
    , "  o  m2/prog6/REF/ensure/TR/WFIS/p/p@prime"
    , "  o  m2/prog6/REF/ensure/TR/flick/EN"
    , "  o  m2/prog6/REF/ensure/TR/flick/NEG"
    , "  o  m2/prog6/REF/ensure/count/SAF"
    , "  o  m2/prog6/REF/ensure/flick/SAF"
    , "  o  m2/prog6/REF/ensure/term/SAF"
    , "  o  m2/prog6/REF/ensure/visit/SAF"
    , "  o  m2/prog7/PROG/WD/lhs"
    , "  o  m2/prog7/PROG/WD/rhs"
    , "  o  m2/prog7/REF/ensure/SAF/WD/lhs"
    , "  o  m2/prog7/REF/ensure/SAF/WD/rhs"
    , "  o  m2/prog7/REF/ensure/TR/WD"
    , "  o  m2/prog7/REF/ensure/TR/count/EN"
    , "  o  m2/prog7/REF/ensure/TR/count/NEG"
    , "  o  m2/prog7/REF/ensure/count/SAF"
    , "  o  m2/prog7/REF/ensure/flick/SAF"
    , "  o  m2/prog7/REF/ensure/term/SAF"
    , "  o  m2/prog7/REF/ensure/visit/SAF"
