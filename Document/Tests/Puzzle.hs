...
test_case = test_cases 
        ...
        , StringCase "test 27, illegal type application" case28 result28
        ]
...
result1 = unlines
    ...
    , "  o  m1/term/CSCH/delay/0/prog/lhs"
    , "  o  m1/term/CSCH/delay/0/prog/rhs/sch1"
    , "  o  m1/term/CSCH/delay/0/saf/lhs"
    , "  o  m1/term/CSCH/delay/0/saf/rhs"
...
result7 = unlines
    ...
    , "  o  m2/count/WD/GRD"
    , "  o  m2/count/WWD"
    , "  o  m2/flick/CSCH/weaken/sch0"
    , "  o  m2/flick/CSCH/weaken/sch1"
    , "  o  m2/flick/CSCH/weaken/sch2"
    ...
    , "  o  m2/term/CSCH/delay/0/prog/lhs"
    , "  o  m2/term/CSCH/delay/0/prog/rhs/sch2"
    , "  o  m2/term/CSCH/delay/0/saf/lhs"
    , "  o  m2/term/CSCH/delay/0/saf/rhs"
...
result8 = unlines 
    ...
    , "  o  m3/count/WWD"
    , "  o  m3/flick/CSCH/weaken/m3:csch1"
    , "  o  m3/flick/CSCH/weaken/m3:csch2"
    ...
    , "  o  m3/term/WWD"
    , "  o  m3/thm0/THM/goal (255,1)"
    , "  o  m3/thm0/THM/hypotheses (255,1)"
    , "  o  m3/thm0/THM/relation (255,1)"
    , "  o  m3/thm0/THM/step (257,1)"
    , "  o  m3/thm0/THM/step (259,1)"
    , "  o  m3/thm0/THM/step (261,1)"
    , "  o  m3/thm0/THM/step (263,1)"
    , "  o  m3/thm0/THM/step (265,1)"
    , "  o  m3/thm0/THM/step (267,1)"
...
result9 = unlines
    ...
    , "                      (= fs (union ts cs))"
    , "                      (= (= n (qsum@@sl@Pcs sl@Pcs (const@@sl@Pcs@@Int 1)))"
    , "                         (= ts sl@Pcs)))"
...
result15 :: String
result15 = unlines
    [ "error: event 'count', action 'act0' refers to deleted variables"
    ...
    , ""
    , "error: event 'flick', action 'act0' refers to deleted variables"
    , "\tdeleted variable 'cs': (116,3)"
    , "\taction 'act0': (163,1)"
    , ""
...
result21 = unlines
    ...
    , "\tpredicate in2: (175,1)"
    , ""
    , "error (204,1): event 'flick', action 'act' was deleted but does not exist"
...
result24 = Right ( S.fromList ["inv0","inv1","inv2","m3:inv0","m3:inv1"
                              ,"m3:inv2","m3:inv3","m3:inv5","m3:inv6"
                              ,"m3:inv7"]
                 , S.fromList [])
