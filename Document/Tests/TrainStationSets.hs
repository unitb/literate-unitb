...
result5 = unlines
    ...
    , "  o  m3/m1:moveout/C_SCH/delay/0/prog/m3:prog0/rhs/c1"
    , "  o  m3/m1:moveout/C_SCH/delay/0/prog/m3:prog0/rhs/m3:mo:sch0"
    , "  o  m3/m1:moveout/C_SCH/delay/0/saf/m3:saf0/lhs"
    , " xxx m3/m1:moveout/C_SCH/delay/0/saf/m3:saf0/rhs"
...
case7 :: IO String
case7 = proof_obligation path0 "m2/TR/m2:tr0/WFIS/t/t@prime" 2

result7 :: String
result7 = unlines
    [ "; m2/TR/m2:tr0/WFIS/t/t@prime"
    , "(set-option :auto-config false)"
    , "(set-option :smt.timeout 3000)"
    , "(declare-datatypes (a) ( (Maybe (Just (fromJust a)) Nothing) ))"
    , "(declare-datatypes () ( (Null null) ))"
...
case10 :: IO String
case10 = proof_obligation path0 "m2/TR/m2:tr0/m0:leave/EN" 2

result10 :: String
result10 = unlines
    [ "; m2/TR/m2:tr0/m0:leave/EN"
    , "(set-option :auto-config false)"
    , "(set-option :smt.timeout 3000)"
    , "(declare-datatypes (a) ( (Maybe (Just (fromJust a)) Nothing) ))"
    , "(declare-datatypes () ( (Null null) ))"
...
case11 :: IO String
case11 = proof_obligation path0 "m2/TR/m2:tr0/m0:leave/NEG" 2

result11 :: String
result11 = unlines
    [ "; m2/TR/m2:tr0/m0:leave/NEG"
    , "(set-option :auto-config false)"
    , "(set-option :smt.timeout 3000)"
    , "(declare-datatypes (a) ( (Maybe (Just (fromJust a)) Nothing) ))"
    , "(declare-datatypes () ( (Null null) ))"
...
case8 :: IO String
case8 = proof_obligation path0 "m3/m1:moveout/C_SCH/delay/0/saf/m3:saf0/rhs" 3

result8 :: String
result8 = unlines
    [ "; m3/m1:moveout/C_SCH/delay/0/saf/m3:saf0/rhs"
    , "(set-option :auto-config false)"
    , "(set-option :smt.timeout 3000)"
    , "(declare-datatypes (a) ( (Maybe (Just (fromJust a)) Nothing) ))"
    , "(declare-datatypes () ( (Null null) ))"
