...
result11 = unlines 
    ...
    , "                  (x Int)"
    , "                  (s1 (set Int)) )"
    , "                (! (=> (elem@@Int x (intersect@@Int (dom@@Int@@Int f1) s1))"
    , "                       (elem@@Int (apply@@Int@@Int f1 x)"
    ...
    , "                          (bunion@@Int (set-diff@@Int (ran@@Int@@Int f1)"
    , "                                                      (mk-set@@Int (apply@@Int@@Int f1 x)))"
    , "                                       (mk-set@@Int y))))"
    , "                   :pattern"
    , "                   ( (ran@@Int@@Int (ovl@@Int@@Int f1 (mk-fun@@Int@@Int x y))) ))))"
    ...
    , "                       (= (ran@@Int@@Int (ovl@@Int@@Int f1 (mk-fun@@Int@@Int x y)))"
    , "                          (bunion@@Int (ran@@Int@@Int f1) (mk-set@@Int y))))"
    , "                   :pattern"
    , "                   ( (ran@@Int@@Int (ovl@@Int@@Int f1 (mk-fun@@Int@@Int x y))) ))))"
    , "(assert (forall ( (x Int)"
    , "                  (y Int) )"
    ...
    , "(assert (forall ( (s1 (set Int))"
    , "                  (s2 (set Int)) )"
    , "                (! (= (= (intersect@@Int s1 s2) empty-set@@Int)"
    , "                      (forall ( (x Int) )"
    , "                              (=> true"
