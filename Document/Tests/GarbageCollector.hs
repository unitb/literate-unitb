...
result1 = unlines
    ...
    , "  o  m1/m1:prog0/REF/ensure/TR/WD/witness/p"
    , "  o  m1/m1:prog0/REF/ensure/TR/WFIS/p/p@prime"
    , "  o  m1/m1:prog0/REF/ensure/TR/free/EN"
    , "  o  m1/m1:prog0/REF/ensure/TR/free/NEG"
    , "  o  m1/m1:prog0/REF/ensure/add/SAF"
    , "  o  m1/m1:prog0/REF/ensure/alloc/SAF"
    , "  o  m1/m1:prog0/REF/ensure/delete/SAF"
    , "  o  m1/m1:prog0/REF/ensure/free/SAF"
    , "passed 72 / 73"
    ]
...
result3 = unlines
    ...
    , "(assert (forall ( (s1 (set Node))"
    , "                  (s2 (set Node)) )"
    , "                (! (=> (subset s1 s2) (=> (finite s2) (finite s1)))"
    , "                   :pattern"
    , "                   ( (finite s2)"
    , "                     (finite s1) ))))"
    , "(assert (forall ( (s1 (set (Pair Node Node)))"
