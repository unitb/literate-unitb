...
--        g = unions . flip L.map (concatMap f $ S.elems ts)
--        
--        extends =  [ set_theory (set_types ts) ]
--        
--        consts = empty
--        dummies = empty
--        
...
--        funs = g $ \t@(t0,t1) ->
--            symbol_table 
--                [  Fun [t0,t1] (dec t "empty-fun") [] $ fun_type t0 t1
--                ,  Fun [t0,t1] (dec t "dom")   [fun_type t0 t1] $ set_type t0
--                ,  Fun [t0,t1] (dec t "ran")   [fun_type t0 t1] $ set_type t1
--                ,  Fun [t0,t1] (dec t "apply") [fun_type t0 t1,t0] t1
--                ,  Fun [t0,t1] (dec t "ovl") [fun_type t0 t1,fun_type t0 t1] $ fun_type t0 t1
--                ,  Fun [t0,t1] (dec t "dom-rest") [set_type t0,fun_type t0 t1] $ fun_type t0 t1
--                ,  Fun [t0,t1] (dec t "dom-subt") [set_type t0,fun_type t0 t1] $ fun_type t0 t1
--                ,  Fun [t0,t1] (dec t "mk-fun") [t0,t1] $ fun_type t0 t1 
--                ,  Fun [t0,t1] (dec t "tfun") [set_type t0,set_type t1] $ fun_set t
--                ,  Fun [t0,t1] (dec t "set") [fun_type t0 t1] $ set_type t1
--                ]
--        fact = g f_facts
--        f_facts (t0,t1) = fromList 
